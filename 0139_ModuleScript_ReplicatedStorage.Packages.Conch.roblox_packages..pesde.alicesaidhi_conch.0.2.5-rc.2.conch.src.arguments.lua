--[[
  Extracted from: ReplicatedStorage.Packages.Conch.roblox_packages..pesde.alicesaidhi+conch.0.2.5-rc.2.conch.src.arguments
  Class: ModuleScript
...
local numberT = {
	convert = function(input)
		...
		if n == nil then error(`{input} is not a valid number`) end
		return n
	end,
