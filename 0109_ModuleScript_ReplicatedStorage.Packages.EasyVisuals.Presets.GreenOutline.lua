--[[
  Extracted from: ReplicatedStorage.Packages.EasyVisuals.Presets.GreenOutline
  Class: ModuleScript
...
-- [[ Script name: GreenOutline, time of decompilation: Sat Jun 28 18:35:20 2025 ]]
...
return function(v2, v3, v4) --[[ Line: 5 ]]
    ...
    local v6 = v1.Gradient.new(v5.Instance, v1.Templates.Green.Color, v1.Templates.Green.Transparency);
    local v7 = 5;
    local v8 = nil;
